...
const SalesReceipt = (props) => {
	...
	const paymentDetails = JSON.parse(props?.transaction?.payment_details);
	...
	return (
		<div className="flex w-full item-start justify-between">
			<div className="flex-col text-center w-full">
						...
						{props?.transaction?.customer && (
							<div>
								...
								<p>
									...
									<span className="font-semibold pl-4">
										{currency(
											parseFloat(props?.transaction?.customer?.account)
										)}
									</span>
								</p>
							</div>
				...
				<div className="flex items-center text-center justify-start">
					<div className="my-2 text-sm">
						...
						<p>
							...
							<span className="font-semibold pl-4">
								{user?.business?.currency}{" "}
								{currency(parseFloat(paymentDetails?.amountTendered))}
							</span>
						</p>
						<p>
							Change:
							<span className="font-semibold pl-4">
								{user?.business?.currency}{" "}
								{currency(
									parseFloat(paymentDetails?.amountTendered) -
				...
				<div className="justify-between w-full flex mb-2 text-lg">
